...
<img style="float: right; padding: 0 0 0 2rem;" src="./screenshots/tray.png"/>This tool it possible to keep a chronically plugged in M1 Macbook at `80%` battery, since that will prolong the longevity of the battery. It is free and open-source and will remain that way.
